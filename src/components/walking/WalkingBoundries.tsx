...
const WalkingBoundries = () => {
    return (
        <>
            <WalkingBoundry groupPosition={new Vector3(-119, -35, 0)} groupRotation={new Euler(0, 0, 0)} />
            <WalkingBoundry groupPosition={new Vector3(119, -35, 0)} groupRotation={new Euler(0, Math.PI, 0)} />
            <WalkingBoundry groupPosition={new Vector3(0, -35, 119)} groupRotation={new Euler(0, Math.PI * .5, 0)} />
            <WalkingBoundry groupPosition={new Vector3(0, -35, -119)} groupRotation={new Euler(0, -Math.PI * .5, 0)} />
        </>
    )
};
